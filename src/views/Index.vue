<template>
  ...
  <div class="posts">
    ...
    <TestCard v-for="item in test_posts" :title="item.title" :sub="item.sub" />
  </div>
...
export default {
  ...
  data() {
    return {
      ...
      test_posts: [{"id":1,"title":"hel2lo","sub":"lol","contant":"test","img":"hello","uploader":"test111243213131231342112","uptime":"1671419855552"},{"id":2,"title":"hel2lo","sub":"lol","contant":"test","img":"hello","uploader":"test111243213131231342112","uptime":"1671419855790"},{"id":3,"title":"hel2lo","sub":"lol","contant":"test","img":"hello","uploader":"test111243213131231342112","uptime":"1671419856921"},{"id":4,"title":"hel2lo","sub":"lol","contant":"test","img":"hello","uploader":"test111243213131231342112","uptime":"1671419857926"}]
    }
  },
  async mounted() {
    // await axios.get('/api/v1/post/').then(resp => { this.test_posts = resp.posts; console.log(this.test_posts) })
